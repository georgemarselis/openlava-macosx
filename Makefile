...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	...
	INSTALL NEWS README THANKS build-aux/compile \
...
STRIP = strip
VERSION = 0
abs_builddir = /Users/gmarselis/src/openlava/src
abs_srcdir = /Users/gmarselis/src/openlava/src
