...
static tcflag_t ctrl_table[CTRL_TABLE_SIZE] =
...
static int chr_table[CHR_TABLE_SIZE] =
  { VINTR, VQUIT, VERASE, VKILL, VEOF, VEOL, VEOL2, VSWTCH, VSTART, VSTOP,
VMIN, VTIME
#                                     define CHR_TABLE_SPLIT    12
  , VSUSP, VDSUSP, VREPRINT, VDISCARD, VWERASE, VLNEXT
};

#define BAUD_TABLE_SIZE 16
static speed_t baud_table[BAUD_TABLE_SIZE] =
