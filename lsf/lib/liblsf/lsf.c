...
{
	// lsfRusage->ru_utime = rusage->ru_utime.tv_sec + rusage->ru_utime.tv_usec / 1000000.0;
	// lsfRusage->ru_stime = rusage->ru_stime.tv_sec + rusage->ru_stime.tv_usec / 1000000.0;
	lsfRusage->ru_utime = rusage->ru_utime.tv_sec + rusage->ru_utime.tv_usec;
	lsfRusage->ru_stime = (suseconds_t) rusage->ru_stime.tv_sec + rusage->ru_stime.tv_usec;
...
//    rusage->ru_utime.tv_sec   = MIN (lsfRusage->ru_utime, LONG_MAX);
	rusage->ru_utime.tv_sec   = lsfRusage->ru_utime;
	
//    rusage->ru_stime.tv_sec   = MIN (lsfRusage->ru_stime, LONG_MAX);
	rusage->ru_stime.tv_sec   = lsfRusage->ru_stime;
...
#endif
#ifdef __linux__
	rusage->ru_utime.tv_usec  = MIN( (suseconds_t) ( lsfRusage->ru_utime - rusage->ru_utime.tv_sec), INT_MAX );
	rusage->ru_stime.tv_usec  = MIN( (suseconds_t) ( lsfRusage->ru_stime - rusage->ru_stime.tv_sec ), INT_MAX );
#endif
