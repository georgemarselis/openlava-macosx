...
ls_rulsf2unix (struct lsfRusage *lsfRusage, struct rusage *rusage)
{
  ...
  rusage->ru_stime.tv_usec =
    MIN ((lsfRusage->ru_stime - rusage->ru_stime.tv_sec) * 1000000, LONG_MAX);
...
%1.0f %1.0f %1.0f", lsfRu->ru_utime, lsfRu->ru_stime, lsfRu->ru_maxrss, lsfRu->ru_ixrss, lsfRu->ru_ismrss, lsfRu->ru_idrss, lsfRu->ru_isrss, lsfRu->ru_minflt, lsfRu->ru_majflt, lsfRu->ru_nswap, lsfRu->ru_inblock, lsfRu->ru_oublock, lsfRu->ru_ioch, lsfRu->ru_msgsnd, lsfRu->ru_msgrcv, lsfRu->ru_nsignals, lsfRu->ru_nvcsw, lsfRu->ru_nivcsw, lsfRu->ru_exutime));
