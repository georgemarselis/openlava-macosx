...
char *
lsb_pendreason (int numReasons, int *rsTb, struct jobInfoHead *jInfoH, struct loadIndexLog *ld)
{
...
// 560
	...
	{ PEND_UKNOWN_567,            "   ", "catgets 567: apparently I am not supposed to exist" },                                        /* catgets 567 */
