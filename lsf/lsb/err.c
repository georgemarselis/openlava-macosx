                ...
                /* catgets 151 */
                    ...
                    /* catgets 166 */
                        ...
                        /* catgets 175 */
                            ...
                            /* catgets 176 */
                /*77*/ "Error 77",
                /* internal only; no need to print message *//* catgets 177 */
                /*78*/ "Error 78",
                /* internal only; no need to print message *//* catgets 178 */
                ...
                /* catgets 180 */
                            ...
                            /* catgets 181 */
                                ...
                                /* catgets 182 */
                                                ...
                                                /* catgets 183 */
                /*84*/ "Error 109",
                /* internal only; no need to print message *//* catgets 184 */
...
lsb_sysmsg (void)
{
    ...
    {
       /* catgets 99 */
      sprintf (buf, "catgets 99: Unknown batch system error number %d", lsberrno);   
        return buf;
    }
...
lsb_sperror (char *usrMsg)
{
    ...
    if ((rtstr =
        (char *) malloc (sizeof (char) * (strlen (errmsg) + 1))) == NULL)
    {
        lserrno = LSE_MALLOC;
        return NULL;
    }
