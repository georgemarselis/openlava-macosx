...
dotypelist (FILE * fp, unsigned int *lineNum, const char *lsfile)
{
	...
	strcpy (allInfo.hostTypes[0], "UNKNOWN_AUTO_DETECT"); // FIXME FIXME FIXME FIXME where is 0 from ?
	shortInfo.hostTypes[0] = allInfo.hostTypes[0];        // FIXME FIXME FIXME FIXME where is 0 from ?
	strcpy (allInfo.hostTypes[1], "DEFAULT");             // FIXME FIXME FIXME FIXME where is 1 from ?
	shortInfo.hostTypes[1] = allInfo.hostTypes[1];        // FIXME FIXME FIXME FIXME where is 1 from ?
