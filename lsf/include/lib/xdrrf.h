...
int lsSendMsg_ (int s, unsigned short opCode, size_t hdrLength, const char *data, char *reqBuf, size_t reqLen, bool_t (*xdrFunc) (), long (*writeFunc) (),  struct lsfAuth *auth);
