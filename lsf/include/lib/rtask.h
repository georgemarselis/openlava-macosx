...
struct lsRequest *lsRGetpidAsync_(unsigned long taskid, pid_t *pid);
pid_t lsRGetpid_(unsigned long taskid, int options);
unsigned int lsRGetpgrp_(int socket, unsigned long taskid, pid_t pid);
