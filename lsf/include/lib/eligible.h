...
size_t  ls_listrtask   ( char ***taskList, int sortflag );
size_t  ls_listltask   ( char ***taskList, int sortflag );
size_t  listtask_      ( char ***taskList, struct hTab *tasktb, int sortflag );
