...
int        lsReqTest_(LS_REQUEST_T *request);
int        lsReqWait_(LS_REQUEST_T *request, int options);
...
LS_REQUEST_T        *lsGetIRProcRusage_(char *host, int tid, pid_t pid, struct jRusage *ru, appCompletionHandler appHandler, void *appExtra);
...
void        lsReqFree_(LS_REQUEST_T *request);
