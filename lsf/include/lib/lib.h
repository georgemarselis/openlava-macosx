...
extern struct lsRequest *lsReqHandCreate_ (int, int, int, void *,
...
extern LS_REQUEST_T *lsIRGetRusage_ (int, struct jRusage *,
				     appCompletionHandler, void *, int);
extern int lsRGetRusage (int, struct jRusage *, int);
extern int lsGetRProcRusage (char *, int, struct jRusage *, int);
extern LS_REQUEST_T *lsGetIRProcRusage_ (char *, int, int, struct jRusage *,
					 appCompletionHandler, void *);

extern int initenv_ (struct config_param *, char *);
extern int readconfenv_ (struct config_param *, struct config_param *,
			 char *);
...
extern struct hostLoad *loadinfo_ (char *, struct decisionReq *, char *,
				   int *, char ***);
...
extern int sendCmdBill_ (int, resCmd, struct resCmdBill *,
			 int *, struct timeval *);
extern void
ls_errlog (FILE * fd, const char *fmt, ...)
