...
int parseLimitAndSpec( const char *word, float *limit, char **spec, const char *hostSpec, const char *param, struct queueInfoEnt *qp, const char *filename, size_t *lineNum, const char *pname);
