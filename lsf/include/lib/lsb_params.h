...
bool checkCpuLimit(char **hostSpec, double **cpuFactor, int useSysDefault, const char *filename, size_t *lineNumber, const char *pname, struct lsInfo *info, int options);
...
int parseLimitAndSpec( const char *word, size_t *limit, char **spec, const char *hostSpec, const char *param, struct queueInfoEnt *qp, const char *filename, size_t *lineNum, const char *pname);
...
int parseDefAndMaxLimits(struct keymap *key, size_t *defaultVal, size_t *maxVal, const char *filename, size_t *lineNum, const char *pname);
